      ...
      <div className="flex items-center justify-between gap-6">
        <div className="max-w-xl flex-shrink-0 animate-fade-up">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            {/* B站：浅色模式半透明粉底+深色文字，暗色模式实色品牌粉 */}
            <a
              href="https://space.bilibili.com/3494356482787443"
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-xl bg-[#FB7299]/12 text-zinc-800 border border-[#FB7299]/30 px-5 py-2.5 text-sm font-medium shadow-sm shadow-[#FB7299]/10 transition-all duration-200 hover:-translate-y-[1px] hover:bg-[#FB7299]/20 hover:border-[#FB7299]/50 hover:shadow-md hover:shadow-[#FB7299]/15 dark:bg-[#FB7299] dark:text-white dark:border-transparent dark:shadow-[#FB7299]/25 dark:hover:bg-[#FC8EAC] dark:hover:shadow-lg dark:hover:shadow-[#FB7299]/30 motion-reduce:transition-none cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="text-[#FB7299] dark:text-white"
              >

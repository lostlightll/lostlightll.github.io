      ...
      <div className="flex items-center justify-between gap-6">
        <div className="max-w-xl flex-shrink-0 animate-fade-up">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              href="/posts"
              className="group inline-flex items-center gap-2 rounded-xl bg-zinc-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm shadow-zinc-900/10 transition-all duration-300 hover:-translate-y-[1px] hover:shadow-md hover:shadow-zinc-900/20 dark:bg-zinc-100 dark:text-zinc-900 dark:shadow-zinc-100/10 dark:hover:shadow-zinc-100/20 motion-reduce:transition-none cursor-pointer"
            >
              <svg
            ...
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-xl border border-zinc-300 bg-white/80 px-5 py-2.5 text-sm font-medium text-zinc-800 shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-[1px] hover:border-zinc-400 hover:bg-white hover:shadow-md dark:border-zinc-700 dark:bg-zinc-900/80 dark:text-zinc-200 dark:hover:border-zinc-500 dark:hover:bg-zinc-900 dark:hover:shadow-zinc-950/50 motion-reduce:transition-none cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"

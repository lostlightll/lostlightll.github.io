        ...
        <div className="max-w-xl flex-shrink-0 animate-fade-up">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-xl bg-[#F8C8D6] px-5 py-2.5 text-sm font-medium text-zinc-800 shadow-sm shadow-[#EBB8C6]/40 transition-all duration-200 hover:-translate-y-[1px] hover:bg-[#F0B0C2] hover:shadow-md hover:shadow-[#E898AC]/40 dark:bg-[#FB7299] dark:text-white dark:shadow-[#FB7299]/25 dark:hover:bg-[#FC8EAC] dark:hover:shadow-lg dark:hover:shadow-[#FB7299]/30 motion-reduce:transition-none cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"

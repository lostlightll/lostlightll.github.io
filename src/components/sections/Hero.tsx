        ...
        <div className="max-w-xl flex-shrink-0 animate-fade-up">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-xl bg-[#FB7299] px-5 py-2.5 text-sm font-medium text-white shadow-sm shadow-[#FB7299]/25 transition-all duration-200 hover:-translate-y-[1px] hover:bg-[#FC8EAC] hover:shadow-md hover:shadow-[#FB7299]/35 dark:hover:shadow-lg dark:hover:shadow-[#FB7299]/30 motion-reduce:transition-none cursor-pointer"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"

    ...
    <Section id="about" title="关于">
      <div className="grid gap-10 md:grid-cols-[2fr_1fr]">
        ...
        <div className="space-y-5">
          <div>
            <dt className="text-xs font-medium text-zinc-500 dark:text-zinc-500 uppercase tracking-wide">常用 ID</dt>
            <dd className="mt-1 text-zinc-900 dark:text-zinc-100">Kha1ed / Nyx / Nyxlium</dd>
          </div>
          <div>
            <dt className="text-xs font-medium text-zinc-500 dark:text-zinc-500 uppercase tracking-wide">所在地</dt>
            <dd className="mt-1 text-zinc-900 dark:text-zinc-100">中国</dd>
          </div>
          <div>
            <dt className="text-xs font-medium text-zinc-500 dark:text-zinc-500 uppercase tracking-wide">主力工具</dt>
